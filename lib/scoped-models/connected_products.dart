...
class ProductsModel extends ConnectedProductsModel {
  ...
  Future<bool> deleteProduct() {
    ...
    return http
        .delete(
            'https://flutter-products-5186c.firebaseio.com/products/${deletedProductId}.json?auth=${_authenticatedUser.token}')
  ...
  void toggleProductFavoriteStatus() async {
    ...
    if (newFavoriteStatus) {
      response = await http.put(
          'https://flutter-products-5186c.firebaseio.com/products/${selectedProduct.id}/wishlistUsers/${_authenticatedUser.id}.json?auth=${_authenticatedUser.token}',
...
class UserModel extends ConnectedProductsModel {
  ...
  Future<Map<String, dynamic>> authenticate(String email, String password,
    ...
    if (mode == AuthMode.Login) {
      ...
      response = await http.post(
        'https://www.googleapis.com/identitytoolkit/v3/relyingparty/signupNewUser?key=AIzaSyBjRbkwezLBR-nK2LZsFySMbBWwZIYLUwM',
        body: json.encode(authData),
        headers: {'Content-Type': 'application/json'},
      );
    }
